    ...
    <div class="bg-white lg:w-1/4 sm:w-3/5 p-[4rem]  shadow sm:rounded-lg">
      <form action="controller.php" method="post">
        ...
        <div class="text-center flex flex-row">
          <button type="submit" name="login" class="mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none mr-4">Login</button>
